import {
  listify as listify_63, mapEntryConstructor as mapEntryConstructor_64, mapConstructor as mapConstructor_65, requireIsArray as requireIsArray__197
  ...
  constructor(name_183, aliases_184, filenames_185, tokens_186) {
    ...
    if (!(tokens_186 !== void 0)) {
      t_188 = new Rule_154("^\\s*\\n {4}", Whitespace_178, "indented");
      {
        ...
        t_194 = mapEntryConstructor_64("root", t_195);
        ...
        t_191 = mapEntryConstructor_64("indented", t_196);
